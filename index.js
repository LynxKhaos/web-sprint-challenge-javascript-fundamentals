...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested function can access the variable internal because it is nested within myFunction's scope, which is where the variable internal lives.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    let newArr = zooAnimals.filter(data => (
      data.population < 5
  ))
  return newArr
    }
  ...
  */
  ...
  function USApop(zooAnimals){
     return zooAnimals.reduce((previous, current) => {
...
class CuboidMakerTwo extends CuboidMaker {
  ...
  cuboidTwo = new CuboidMaker ({length: 4, width: 5, height: 5 })
  }
